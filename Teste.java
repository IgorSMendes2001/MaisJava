...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        cc4.deposita(222.0);
            ...
            lista.sort(titularComparator);//Serve para ordenar as listas de acordo com o parâmetro desejado;
           System.out.println("---------------------------->");
            for (Conta conta : lista) {
    ...
    class TitularCompara implements Comparator<Conta>{
        ...
        public int compare(Conta c1, Conta c2) {
            ...
            return nomeC1.compareTo(nomeC2);//Compara dois strings sendo ordenados em ordem alfabética;
        }
